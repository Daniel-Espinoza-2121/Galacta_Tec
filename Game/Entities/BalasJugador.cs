...
namespace Galacta_Tec.Entidades
{
    ...
    public class BalaJugador : Entidad, IEntity
    {
        ...
        public BalaJugador(Vector2 posicionInical, bool active, Texture2D texture)
        {
            _tag = TypeEntity.BalaJugador;
        ...
        public void OnCollision(CollisionEventArgs collisionInfo)
        {
            ...
            if (tag == TypeEntity.NaveEnemiga)
            {
                entidad.recibirDaño(0);
                SetActive(false);
                Posicion.X = -100;
                Posicion.Y = -100;
            }
